...
export class InitFrameService {
  constructor(private ioService: IOService,private router: Router, private dicService: DicService, private wsk: StompService, private webRtcService: WebRtcService, private dataBusService: DataBusService, private serverTimeService: ServerTimeService) {
    //全局初始化
