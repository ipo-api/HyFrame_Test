...
## 🚀 Version 4.7.3 _(2025-12-23)_

### 🛠️ 修复
- 修复 `hy-glt` 无总数分页下一页按钮样式异常
- 修复 `hy-tree` 右键弹窗后样式异常

---

## 🚀 Version 4.7.2 _(2025-12-18)_

### 🛠️ 修复
- 修复 `hy-icon` 样式问题
- 修复 `hy-textarea`、`hy-title` 字体样式异常
- 修复 `hy-readonly` 复制时多出空格

### hy-main-page版本兼容
- 此版本建议升级 `hy-main-page` 至 `1.1.1` 版本，因为 `hy-main-page` 1.1.1 版本修复了 `hy-frame` 4.7.2 版本的兼容性问题。
